<template>
  <div id="gather">
    <Top></Top>
    <Logo></Logo>
    <section id="content" v-if="orderInfo">
      <!-- 主體內容 -->
        ...
        <div class="mainPart">
          ...
          <div class="main_headline">
            ...
            <div class="main_head_title">
              ...
              <div class="head_tit_time">貨款金額: {{orderInfo.total_price}}{{ orderInfo.money_type}}</div>
            </div>
          </div>
          <!-- 基本信息 -->
            ...
            <div class="main_base_content">
              ...
              <table>
                ...
                <tr>
                  <td>競價開始時間</td>
                  <td>:</td>
                  <td>{{orderInfo.bid_start_date.split("T")[0] }}</td>
                </tr>
                <tr>
                  <td>競價結束時間</td>
                  <td>:</td>
                  <td>{{orderInfo.bid_end_date.split("T")[0] }}</td>
                </tr>
              </table>
            </div>
          </div>
